...
public class IndexInfoJsonUtil {
    ...
    private static final long INITNUMS = 100;
    private static final long EACH_SLICES = 100;
    private static final int WRONG_DATA = 100;
    private static final int WRONG_DATA_TYPE = 100;

        private static final String FILE_PATH = "src/main/resources/testFile/indexInfoS/import";
//    private static final String FILE_PATH = "/nvme2/100Y/import";
