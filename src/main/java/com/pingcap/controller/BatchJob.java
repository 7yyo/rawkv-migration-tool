            ...
            for(Entry<String, String> pos:lineBlock.entrySet()) {
	            ...
	            if(batchSize <= kvPairs.size()){	            	
	            	try{
	                	...
	                	cmdInterFace.getLoggerFail().error("Failed to batch put, file={}, size={}, line={}", absolutePath, kvPairs_lines.size(), DataFactory.getRowsHeader(kvPairs_lines));
	                }
	            	finally{
	            ...
	            if(batchSize <= kvPairsTtl.size()){
	            	try{
	            		...
	            		cmdInterFace.getLoggerFail().error("Failed to batch put TTL, file={}, size={}, line={}", absolutePath, kvPairsTtl_lines.size(), DataFactory.getRowsHeader(kvPairsTtl_lines));
	            	}
	            	finally{
